    ...
    return (
        <div className="relative">
            ...
            <div className="absolute inset-0 flex flex-col items-center md:items-start justify-end md:justify-center pb-24 md:pb-0 px-4 md:pl-18 lg:pl-24">
                <h1 className="text-3xl text-gray-700 md:text-4xl lg:text-5xl font-bold text-center md:text-left max-w-72 md:max-w-80 lg:max-w-105 leading-tight lg:leading-15">
                ...
                <div className="flex items-center mt-6 font-medium">
                    ...
                    <Link to='/products' className="group hidden md:flex items-center gap-2 px-7 font-semibold md:px-9 py-3 transition rounded cursor-pointer">
                        Explore Deals
